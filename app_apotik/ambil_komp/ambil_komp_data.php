...
<div class="br-mainpanel">
      ...
      <div class="br-pagetitle">
       <i class="fa fa-gift fa-4x"></i>
        ...
        <div>
          <h4>Data Pengambilan Obat Pasien Komplementer</h4>
          <p class="mg-b-0">Berikut adalah data obat pasien komplementer yang telah siap di ambil.</p>
        </div>
      </div><!-- d-flex -->
	...
	while ($myData = mysql_fetch_array($myQry)) {
		...
		$stAmbil= $myData['status_ambil'];
		
		if ($stAmbil == "0"){
			$hsLunas	= "Belum";			
		} else if ($stAmbil == "1"){
			$hsLunas	= "Sudah di ambil";
		} else if ($stAmbil == "2"){
			$hsLunas	= "Sudah di kirim";
		}
	...
	?>
                <tr>
				  ...
				  <td>
				  <?php if ($stAmbil == "0") { ?>  
				   <a href="?open=Ambil-Obat-K-Proses&amp;Kode=<?php echo $Kode; ?>" class="btn btn-info"> Ambil Obat</a>
				  <?php } else { ?>
