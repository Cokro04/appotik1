...
<div class="br-mainpanel">
  ...
  <div class="br-pagebody">
    <div class="br-section-wrapper">
      ...
      <br>
      <a href="?open=Obat-Add" class="btn btn-info btn-fill"><i class="fa fa-plus"></i> Input Obat</a>
      <br>
      <br>

      <div class="table-wrapper">
        <!-- tebel untuk data obat -->
        <table id="example" class="table display responsive nowrap">
          ...
          <tbody>
            ...
            $mySql   = "SELECT obat_copy.*, bentuk_sediaan.*, satuan_obat.* FROM obat_copy
			                 ...
			                 LEFT JOIN satuan_obat ON satuan_obat.kode_satuan = obat_copy.kode_satuan ORDER BY obat_copy.nama_obat";
            ...
            ?>
              <tr>
                ...
                <td align="center"><a href="?open=Obat-Edit&amp;Kode=<?php echo $Kode; ?>" class="badge badge-info"><i class="fa fa-edit"></i> Edit</a> <a href="" class="badge badge-success" data-toggle="modal" data-target="#modaldemo3<?= $myData['kode_obat']; ?>"><i class="fa fa-file"></i> Detail</a>
                ...
                <!-- modal untuk  detail data pasien-->
