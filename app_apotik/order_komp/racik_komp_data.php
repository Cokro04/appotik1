...
<div class="br-mainpanel">
  ...
  <div class="br-pagetitle">
    ...
    <div>
      <h4>Proses peracikan obat pasien komplementer</h4>
    ...
    <div class="br-section-wrapper">
      ...
      if (isset($_POST['btnSimpan'])) {
        ...
        if (count($pesanError) >= 1) {
          ...
          $mySql    = "UPDATE order_obat_komp SET status_racik = '1' WHERE no_registrasi = '$Kode'";
          $myQry    = mysql_query($mySql, $koneksidb) or die("Gagal query" . mysql_error());

          if ($myQry) {

            $_SESSION['pesan'] = 'Proses peracikan obat komplemeter berhasil. Terima kasih';
...
ORDER BY obat_herbal.nama_obat_herbal";
      ...
      <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="form1" target="_self" enctype="multipart/form-data" class="pure-form">
        ...
        <a href="?open=Order-Obat-K" class="btn btn-secondary">
          < Kembali</a>
            <button class="btn btn-success" name="btnSimpan" onclick="return confirm('Yakin akan di racik ?')">Racik Obat Sekarang</button>
