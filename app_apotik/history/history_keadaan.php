...
<div class="br-mainpanel">
      ...
      <div class="br-pagetitle">
        ...
        <div>
          <h4>Histori Follow up keadaan Pasien Komplementer</h4>
      ...
      <div class="br-pagebody">
        <div class="br-section-wrapper">
 		...
 		<h6 class="br-section-label">Data History Follow up</h6>
...
$myData	= mysql_fetch_array($myQry);
	...
	$dataBaik			= isset($_POST['txtBaik']) ? $_POST['txtBaik'] : $myData['keadaan_baik'];
	$dataBuruk			= isset($_POST['txtBuruk']) ? $_POST['txtBuruk'] : $myData['keadaan_buruk'];
...
<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="form1" target="_self" enctype="multipart/form-data" class="pure-form">			
          ...
          <div class="form-layout form-layout-2">
            <div class="row no-gutters">
			  ...
			  <div class="col-md-12">
                <div class="form-group">
                  <label class="form-control-label">Keadaan Baik : </label>
					<textarea class="form-control" name="txtBaik" readonly><?php echo $dataBaik ?></textarea>
                </div>
              </div><!-- col-4 -->

              <div class="col-md-12">
                <div class="form-group">
                  <label class="form-control-label">Keadaan Buruk : </label>
                  <textarea class="form-control" name="txtBuruk" readonly><?php echo $dataBuruk ?></textarea>
                </div>
              </div><!-- col-4 -->
