...
<div class="br-mainpanel">
      ...
      <div class="br-pagetitle">
        ...
        <div>
          <h4>History Follow up verifikasi pembayaran tagihan obat pasien komplementer selanjutnya</h4>
...
<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="form1" target="_self" enctype="multipart/form-data" class="pure-form">			
          ...
          <div class="form-layout form-layout-2">
            <div class="row no-gutters">
			  ...
			  <div class="col-md-12">
                <div class="form-group">
                  <label class="form-control-label">Pastikan pasien sudah membayar tagihan obat : </label>
