  ...
  <table width="100%">
    ...
    <tr>
      <td height="20" colspan="2"><center>
        <strong>PENGADAAN OBAT</strong>
      </center></td>
    </tr>
  </table>

<?php
$date2  = date_create($myData['tanggal_transaksi']);
...
?>
  ...
  <table width="100%">
    ...
    <tr>
      ...
      <td align="right"><?php echo date_format($date2, 'd-m-Y'); ?></td>
    </tr>
    <tr>
      <td>Supplier</td>
      <td>:</td>
  ...
  <table width="100%">
    <tbody>
      <tr>
        <td align="left">Adapun jenis obat yang di pesan sebagai berikut :</td>
      </tr>
    </tbody>
  </table>
